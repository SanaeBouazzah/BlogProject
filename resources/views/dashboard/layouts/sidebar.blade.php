<div class="sidebar">
  <nav class="sidebar-nav">
      <ul class="nav">
          <li class="nav-item">
              <a class="nav-link" href="{{route('settings.index')}}"><i class="icon-speedometer"></i>{{__('words.dashboard')}}<span class="tag tag-info">جدید</span></a>
          </li>
          ...
          <li class="nav-title">
           ...
           <li class="nav-item">
              <a class="nav-link" href="{{route('settings.update')}}"><i class="icon-people"></i>{{ trans('words.settings') }}</a>
